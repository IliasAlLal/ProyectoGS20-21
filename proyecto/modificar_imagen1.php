...
if(empty($_REQUEST['id'])){// verifica si en la url hay un id
	...
	if(!empty($_POST) && is_uploaded_file($_FILES['imag_file']['tmp_name'])){ //si le damos al boton aceptar
	  ...
	  //recogemos el valor del formulario para recoger el id del usuario
			$sql = "UPDATE productos SET Imagen='$ruta' WHERE ID='$idproducto'";
						...
						<div class="col-12 mt-4">
							...
							<form enctype="multipart/form-data" method="POST"  action="">
								...
								<div class="col-12 m-3">
									<img id="imgSalida1" src="imagenes/<?php echo $imagen;?>" width="300" />
								</div>
								<div><b>Subir imagen de producto</b></div> 
