						...
						<div class="col-12 mt-4">
							...
							<form enctype="multipart/form-data" method="POST"  action="">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" readonly class="form-control" name="nombreproducto" value="<?php echo $nombreproducto?>">
									</div>
								</div>
								<div class="form-group row">
									<label for="staticEmail" class="col-sm-2 col-form-label">Precio</label>
									<div class="col-sm-10">
										<input type="text" readonly class="form-control" name="precio" value="<?php echo $precio?>">
									</div>
								</div>
								<div class="form-group row">
									<label for="inputPassword" class="col-sm-2 col-form-label">Descripcion</label>
									<div class="col-sm-10">
										<input type="text" readonly class="form-control"  value="<?php echo $descripcion?>"name="descripcion"  placeholder="Password">
									</div>
								</div>
								<b>Imagen actual</b> 
